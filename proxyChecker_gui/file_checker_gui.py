...
class Ui_ProxyChecker(object):
    def setupUi(self, ProxyChecker):
        ...
        self.label_10.setGeometry(QRect(120, 120, 191, 31))
        font = QFont()
...
class PR_CH(QtWidgets.QMainWindow, Ui_ProxyChecker):  # Собираем класс с нашими основными действиями
    ...
    def one_check(self, prxtchck):
        try:
            ...
            print("Proxy " + str(prxtchck) + " OK", file=output)
            output.close()
...
if __name__ == '__main__':
    ...
    prch_gui = PR_CH()  # Сoздание инстанса класса Калькулятор, который мы создадим далее
